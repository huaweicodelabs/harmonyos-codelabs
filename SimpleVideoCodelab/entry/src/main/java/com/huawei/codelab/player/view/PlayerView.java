...
package com.huawei.codelab.player.view;

import com.huawei.codelab.player.api.ImplPlayModule;
import com.huawei.codelab.player.api.ImplPlayer;
import com.huawei.codelab.player.constant.Constants;
import com.huawei.codelab.player.manager.GestureDetector;
...
public class PlayerView extends DependentLayout implements ImplPlayModule, LayoutRefreshedListener {
    ...
    private void addGestureView() {
        ...
        DependentLayout.LayoutConfig config =
                new DependentLayout.LayoutConfig(Constants.NUMBER_300, ComponentContainer.LayoutConfig.MATCH_CONTENT);
