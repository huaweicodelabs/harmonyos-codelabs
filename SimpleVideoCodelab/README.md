# SimpleVideoCodelab
简介
• 此Demo用于简单地使用视频播放器。您可以方便、快捷地接入并实现视频播放，然后可以对播放内容的一些相关操作。
...
What is it?
This demo is used to simply use a video player. You can access and play videos conveniently and quickly, and then perform operations on the content to be played.
