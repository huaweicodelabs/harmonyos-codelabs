...
请参阅LICENSE文件以获得更多信息。
What is it?
This demo shows how to develop a 2x2 movie card on a mobile phone. Slide up the app icon to create a card. The card list will automatically refresh related content. Touch the card icon to go to the app home page.
