...
简介
• 此Demo通过一个简单的样例，展现了ACE 2.0转场动画的使用。其中包含页面间转场、组件内转场以及共享元素转场。
...
What is it?
This demo shows the use of ACE 2.0 transition animation through a simple example. These include inter-page transitions, intra-component transitions, and shared element transitions.
