...
What is it?
This CodeLab aims to let developers understand the common layouts and usage methods of common components for mobile HarmonyOS application development, and experience the whole process from project creation to code and layout writing, to compilation, construction, deployment, and operation.
