#  SliderEts
简介
• 此Demo通过一个简单的样例，使用JS UI 2.0开发框架的基础组件Image组件、Slider组件、Text组件共同实现一个可调节的风车动画。
...
What is it?
This demo uses a simple example to implement an adjustable windmill animation by using the Image, Slider, and Text components of the JS UI 2.0 development framework.
